...
struct qt_meta_stringdata_ludo_player_theis_t {
    QByteArrayData data[10];
    char stringdata0[134];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ludo_player_theis_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ludo_player_theis_t qt_meta_stringdata_ludo_player_theis = {
    {
QT_MOC_LITERAL(0, 0, 17), // "ludo_player_theis"
QT_MOC_LITERAL(1, 18, 12), // "select_piece"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 13), // "turn_complete"
QT_MOC_LITERAL(4, 46, 10), // "start_turn"
QT_MOC_LITERAL(5, 57, 18), // "positions_and_dice"
QT_MOC_LITERAL(6, 76, 8), // "relative"
QT_MOC_LITERAL(7, 85, 18), // "post_game_analysis"
QT_MOC_LITERAL(8, 104, 16), // "std::vector<int>"
QT_MOC_LITERAL(9, 121, 12) // "relative_pos"

    },
    "ludo_player_theis\0select_piece\0\0"
...
void ludo_player_theis::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ludo_player_theis::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ludo_player_theis::select_piece)) {
                *result = 0;
            }
        }
        {
            typedef void (ludo_player_theis::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ludo_player_theis::turn_complete)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject ludo_player_theis::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ludo_player_theis.data,
      qt_meta_data_ludo_player_theis,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ludo_player_theis::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ludo_player_theis.stringdata0))
